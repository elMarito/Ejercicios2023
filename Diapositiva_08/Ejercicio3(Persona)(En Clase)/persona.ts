export class Persona {
    ...
    protected distanciaPasoMts: number;
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    // public correr(): void {  }
//    public avanzar(mts: number, persona: string): void { console.log(persona, `avanza ${mts} metros.`) }
    public caminar(): void { console.log(`La persona avanza ${this.distanciaPasoMts} metros caminando.`) }
    public correr(): void { console.log(`La persona avanza ${this.distanciaPasoMts * 2} metros corriendo.`) }
}